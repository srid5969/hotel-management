...
import {CompanyController} from "app/company/controller/company";
...
export default async function bootstrap(configuration: Configuration, listen = true): Promise<void> {
	...
	const server = application.create(new ExpressAdapter(), {
		...
		controllers: [AccessTokenGeneratorForRefreshToken, UserController, CompanyController],
